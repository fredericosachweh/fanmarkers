...
var labels =
	[	
		new ELabel(new GLatLng(10.885097,20.361325),
		    africa[1] + "<br>" + africa[2],
		    "overlay_number", offset),
		    
		new ELabel(new GLatLng(-13.137258,-59.824226),
		    americas[1] + "<br>" + americas[2],
		    "overlay_number", offset),
		    
		new ELabel(new GLatLng(18.746149,-71.777351),
		    carribean[1] + "<br>" + carribean[2],
		    "overlay_number", offset),
		    
		new ELabel(new GLatLng(65.315500,-153.662113),
		    alaska[1] + "<br>" + alaska[2],
		    "overlay_number", offset),
		    
		new ELabel(new GLatLng(-25.593975,138.837887),
		    australia[1] + "<br>" + australia[2],
		    "overlay_number", offset),
		    
		new ELabel(new GLatLng(59.471873,-103.037113),
		    canada[1] + "<br>" + canada[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(34.328693,100.869137),
		    china[1] + "<br>" + china[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(43.187448,27.919918),
		    e_europe[1] + "<br>" + e_europe[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(49.644869,1.419918),
		    europe[1] + "<br>" + europe[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(24.415142,76.7207),
		    india[1] + "<br>" + india[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(1.810246,119.87695),
		    indonesia[1] + "<br>" + indonesia[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(28.659744,49.716793),
		    middle_east[1] + "<br>" + middle_east[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(65.3155,82.412106), 
		    russia[1] + "<br>" + russia[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(65.960532,20.712887),
		    scandanavia[1] + "<br>" + scandanavia[2],
		    "overlay_number", offset),
		     
		new ELabel(new GLatLng(39.524382,-98.100588),
		    usa[1] + "<br>" + usa[2],
		    "overlay_number", offset),
	]
	

function make_json(data, responseCode) {
...
function initialize()
{
    ...
    //move the controls down so they are below the menu bar
	...
	GEvent.addListener(map, "click", function(marker, point) {
	    ...
	    url = sprintf("/map_click/%s_%s_%s/",
                      map.getZoom(), point.lat(), point.lng())
    
        GDownloadUrl(url, make_json)
